 ...
 * - Se agrupan mediante el atributo name.
 * - Ofrecen una opción entre varias. Si no están agrupados por nombre, se señalan tantos como quieras.
 * 
 * 
 * */


public class EradioButton {
	...
	*/
		...
		radioButtonAgua.click();
		Thread.sleep(2000);
		radioButtonDorada.click();
		Thread.sleep(2000);
		boton.click();
		Thread.sleep(2000);
	}
